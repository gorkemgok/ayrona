...
/**
 * Created by gorkemgok on 25/03/16.
 */
@Fn(name = "EMA")
public class EMA extends AbstractPeriodicFunction {
    ...
    public FIOExchange calculate (FIOExchange inputs, double... params) {
        ...
        Core core = new Core();
        core.ema (0, inputs.getDataSize (0) - 1, inputs.getData (0), (int)params[0], outBegIdx, outNBElement, output);
