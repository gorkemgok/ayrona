...
/**
 * Created by gorkemgok on 27/03/16.
 */
@Fn(name = "TRIX")
public class TRIX extends AbstractPeriodicFunction {
    ...
    public FIOExchange calculate (FIOExchange inputs, double... params) {
        ...
        Core core = new Core();
        core.trix (0, inputs.getDataSize (0) - 1, inputs.getData (0), (int)params[0], outBegIdx, outNBElement, output);
