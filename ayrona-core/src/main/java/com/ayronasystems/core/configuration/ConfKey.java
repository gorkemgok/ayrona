...
public enum ConfKey {
    ...
    ATA_GTP_HOST (PROP_ATA_GTP_HOST, ENV_ATA_GTP_HOST, "algo.ataonline.com.tr"),

    ATA_DATA_HPLIST (PROP_ATA_DATA_HPLIST, ENV_ATA_DATA_HPLIST, "172.16.192.40:7000"),

    ATA_DATA_RETRY_COUNT (PROP_ATA_DATA_RETRY_COUNT, ENV_ATA_DATA_RETRY_COUNT, "200"),

    ATA_DATA_RETRY_WAIT (PROP_ATA_DATA_RETRY_WAIT, ENV_ATA_DATA_RETRY_WAIT, "5"),

    ATA_VOB30_CODE (PROP_ATA_VOB30_CODE, ENV_ATA_VOB30_CODE, "F_XAUTRYM0816S0"),

    SYMBOLS (PROP_SYMBOLS, ENV_SYMBOLS, "FX_EURUSD-EURUSD,FX_USDTRY-USDTRY"),
    ;
